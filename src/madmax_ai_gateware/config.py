...
class Build(BaseModel):
    output_dir: str = "gateware_build/generated"
    artifact_dir: str = "gateware_build/artifacts"
...
class ExperimentConfig(BaseModel):
    ...
    @property
    def description_json_path(self) -> Path:
        if self.build.description_json:
            return resolve_workspace_path(self.build.description_json)
        return self.output_dir / f"{self.target.variant}.json"
